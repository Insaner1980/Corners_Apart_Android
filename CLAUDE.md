...
- `review/` transiently reconstructs just-finished local games, including history-omitted finishing passes, and evaluates owner 0 actions with deterministic full-candidate MASTER/BLOCKER `MoveEvaluator` scoring; review state is ViewModel-owned only and is never persisted or sent through Nearby
